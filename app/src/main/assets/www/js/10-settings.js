...
function applyVisualSettings(){
 const fonts={system:'system-ui,-apple-system,"Segoe UI",sans-serif',serif:'"Noto Serif","Droid Serif",serif',classic:'Georgia,"Times New Roman",serif',sans:'Arial,"Segoe UI",sans-serif',mono:'ui-monospace,Consolas,monospace'};
